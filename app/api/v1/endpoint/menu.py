...
async def get_all_menus(menu: Annotated[MenuService, Depends()]) -> list[MenuBaseSchema]:
...
async def create_menu(menu_data: CreateMenuSchema, menu: Annotated[MenuService, Depends()]):
